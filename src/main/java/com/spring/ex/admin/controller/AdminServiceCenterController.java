...
public class AdminServiceCenterController {
	...
	@Inject
	AdminServiceCenterService service;
	...
	public String NoticeBoardView(NoticeBoardVO vo, Model model, HttpServletRequest request,
	...
	public String ModifyView(NoticeBoardVO vo, Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		int nId = Integer.parseInt(request.getParameter("nId"));
	...
	public @ResponseBody int AnswerWrite(InquiryAnswerVO vo, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public String InquiryBoardView(Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public void AnswerModify(InquiryAnswerVO vo, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public String CategoryView(@RequestParam(value = "category", required = false) String category,
	...
	public String FAQBoardView(FAQVO vo, Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public String FAQAllView(@RequestParam(value = "category", required = false) String category,
