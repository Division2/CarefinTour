...
<body>
	...
	<div class="page-wrapper">
		...
		<section class="page-header" style="background-image: url(<c:url value="/resources/images/banner_main/${BannerRespectivelyView6.getS_file_name()}"/>);">
			<div class="container">
				<h2>유럽/아프리카</h2>
								...
								<div class="tour-two__single tour-one__single">
									<div class="tour-two__image-wrap">
										<div class="tour-one__image" style="width:350px;">
											<img src='<c:url value="/resources/images/product_package/${plist4.getS_file_name()}"/>' height=400 alt="">
									...
									<div class="tour-one__content">
										<div class="tour-two__top">
											...
											<div class="tour-two__right">
												<p><span>$<fmt:formatNumber value="${plist4.getAdultprice()}" pattern="###,###,###"/></span> <br> 인당 가격</p>
											</div>
										</div>
