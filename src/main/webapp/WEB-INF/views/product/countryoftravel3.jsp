									...
									<div class="tour-one__content">
										<div class="tour-two__top">
											<div class="tour-two__top-left">
												<h3><a href="detailInfo">${plist3.getProductname()}</a></h3>
											</div>
										...
										<ul class="tour-one__meta list-unstyled">
											<li><a href="detailInfo"><i class="far fa-clock"></i>${plist3.getStartravelperiod()}~${plist3.getArrivaltravelperiod()}</a></li>
											<li><a href="detailInfo"><i class="far fa-user-circle"></i> ${plist3.getMinreservation()}+이상</a></li>
											<li><a href="detailInfo"><i class="far fa-map"></i>${plist3.getTheme()}</a></li>
										</ul>
									</div>
								</div>
							</c:forEach>
