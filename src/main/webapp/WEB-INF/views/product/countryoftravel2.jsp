...
<body>
	...
	<div class="page-wrapper">
		...
		<section class="page-header" style="background-image: url(<c:url value="/resources/images/banner_main/${BannerRespectivelyView4.getS_file_name()}"/>);">
			<div class="container">
				<h2>대만/동남아/서남아</h2>
									...
									<div class="tour-one__content">
										<div class="tour-two__top">
											<div class="tour-two__top-left">
												<h3><a href="detailInfo?PID=${plist2.getPid()}">${plist2.getProductname()}</a></h3>
											</div>
											<div class="tour-two__right">
												<p><span>$<fmt:formatNumber value="${plist2.getAdultprice()}" pattern="###,###,###"/></span> <br> 인당 가격</p>
											</div>
										</div>
										<div class="tour-two__text">
											<c:out escapeXml="false" value="${fn:replace(fn:replace(plist2.getOverview(), '&lt;', '<'), '&gt;', '>')}"/>
										</div>
										<ul class="tour-one__meta list-unstyled">
											<li><a href="detailInfo?PID=${plist2.getPid()}"><i class="far fa-clock"></i>${plist2.getStartravelperiod()}~${plist2.getArrivaltravelperiod()}</a></li>
											<li><a href="detailInfo?PID=${plist2.getPid()}"><i class="far fa-user-circle"></i> ${plist2.getMinreservation()}+이상</a></li>
											<li><a href="detailInfo?PID=${plist2.getPid()}"><i class="far fa-map"></i>${plist2.getTheme()}</a></li>
										</ul>
									</div>
								</div>
							</c:forEach>
