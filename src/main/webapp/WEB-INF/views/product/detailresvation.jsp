...
function iamport(){
	...
	IMP.init('imp85218251');
	IMP.request_pay({
	    pg : 'html5_inicis',
	    pay_method : 'card',
	    merchant_uid : 'merchant_' + new Date().getTime(),
	    name : '${pdtail.getProductname()}' , //결제창에서 보여질 이름
	    amount :'${param.Payment}', //실제 결제되는 가격
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="d-flex">
					<div class="mx-auto">
						<c:if test="${sessionScope.member ne null}">
							<button type="button" id="check_module" onclick="iamport()"class="thm-btn-psd">결제하기</button>
