...
<head>
<meta charset="UTF-8">
<title>케어핀투어 - 여행자보험</title>
<link href='<c:url value="/resources/css/section.css"/>' rel="stylesheet">
<link href='<c:url value="/resources/css/insurance.css"/>' rel="stylesheet">
...
<body>
	...
	<div class="container">
		<div class = "row">
		<div class="col-md-8">
		   <h2><strong>여행자보험</strong></h2><p/>
				<p><h4>여행 출발하기 전 각종정보를 꼭 확인하시고</h4><p/>
				<h4>더욱 편안한다 여행되시길 바랍니다.</h4><p/>
				</div>
		</div>
				...
				<p><ul class="nav nav-tabs nav-justified">
					...
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab"style="background:#f1f3f5;width:370px;height:100px;"href="#zxc">
							<strong>보험약관</strong></a>
								</li>
									</ul>													
								<div class="tab-content">
									<div class="tab-pane fade show active" id="qwe">
										 <p><h3><strong>해외/국내 보험이란?</strong></h3></p>
                                <p><h5 style="color:#4A4F5A;">해외·국내 여행보험은 여행 중 발생하는 사고에 대한 보상을 해주는 여행종합보험입니다.</h5></p>
							<table class="table">
								<tr>
									<th bgcolor="white" height="80px" style="border: solid 2px #E2E2E2;">
										<dl>
			                                <dt style="color:#4B89DC;font-size:20px;">                                    
			                                        문의전화
			                                    </dt>
			                                    <dd>
			                                        <p>
			                                            <b style="font-size:20px"><strong>DB손해보험 &nbsp: </strong></b>
			                                            &nbsp질병/상해 관련 : 1566-1040 휴대품관련 1899-4040 _ 1588-0100
			                                        </p>
			                                        <p>
			                                            <b style="font-size:20px"><strong>MG손해보험 &nbsp: </strong></b>
			                                           &nbsp 02-3702-2326
			                                        </p>
			                                    </dd>
			                                </dl>								
                                ...
                                <p><h5 style="color:#4A4F5A;">해당 나이는 보험나이를 기준으로 하며, 보험나이는 피보험자의 실제 만 나이를 기준으로 6개월 미만의 끝수는 버리고 6개월 이상의
                                <br />끝수는 1년으로 하여 계산하고, 이후 매년 계약 해당일에 나이가 증가하는 것으로 합니다.</h5></p>
                                <table class="table">
								<tr>
									<th bgcolor="white" height="80px" border="black">
                                    	...
                                    	<p style="color:#4A4F5A;font-size:17px;">
	                                        ...
	                                        29년 6월 11일 = 30세<br />생년월일: 1988년 12월 2일, 현재(계약일): 2018년 4월 13일 ⇒ 2018년
		                       ...
		                       <h3><strong>해외/국내 여행자보험 보상한도액</strong></h3>
                                <p><h5 style="color:#4A4F5A;">2020.03.19 출발부터 적용되며, 2009 7월부터 '본인분담금제도' 도입으로 의료비청구시 본인분담금을 제외한 금액만 보장됩니다.</h5></p>
                                <br/><h4>DB손해보험 해외여행</h4><hr color="#4A4F5A">
                                ...
                                <h4>DB손해보험 해외여행</h4>                                                           
                                    <table summary="DB손해보험 해외여행보상한도내용" style="border:solid 2px #f1f3f5;text-align:center;font-size:18px;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th colspan="2" scope="row" class="tc">(해외)여행중 휴대품손해<br>(분실제외,면책금1만원)</th>
                                                <td>500,000원</td>
                                                <td>500,000원</td>
                                                <td>1,000,000원</td>
                                                <td>200,000원</td>
                                ...
                                <p>※ 만 14세 이하는 후유장해에 대해서만 보상합니다. (사망시 제외)</p><br/>
                                
                                 <h4>DB손해보험 국내여행</h4><hr color="#4A4F5A">                     
                                ...
                                <h4>MG손해보험 해외여행</h4><hr color="#4A4F5A">                      
                                    <table summary="DB손해보험 국내여행보상한도내용"style="text-align:center;font-size:18px;">
                                        <caption class="hide">여행자보험 표</caption>
                                        <colgroup>
                                            <col width="8%">
                                            <col width="19%">
                                            <col width="14%">
						...
						<div class="tab-pane fade" id="asd">								
                            <br/> <h5 style="color:#4A4F5A;">금융위원회는 09.07.16 보험업감독 규정 개정안에서 건강보험 재정 개선을 위해
                             [자기부담금제도]를<br />도입하였습니다. 이에 따라 의료비 청구인 경우 [자기부담금]을 제외한 치료실비만 보장됨을 알려드립니다.</h5>
                            			</p>
                            		<br/><h4 align="center" style="color:#4B89DC;">DB/MG손해보험(해외)</h4>
                            		<br/><h3><strong>DB/MG 손해보험 해외보험 보상기준</strong></h3>
                            		<br/><h5><strong>해외여행보험의 보상내역</strong></h5><hr color="black">
                                            <div class="font">
                                                <table summary="해외여행보험의 보상내역내용" style="font-size:18px;">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <p>
							                                                                피보험자가 해외여행도중 상해의 직접결과로써 사망하거나 약관상 장해분류표에서 정한 각
							                                                                장해지급률에<br> 해당하는 장해 상태가 되었을경우.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>                                                          
							                                                                ...
							                                                                때에는 보험<br>가입금액을 한도로 피보험자가 실제 부담한 의료비 전액 보상 (척추지압술,침술은
                                                                US$ 1,000.00 한도로<br>보상)<br>- 치료를 받던 중 보험기간이 만료되었을 경우에는
                                                               	 보험기간 종료일로부터 180일까지 보상(보험기간 종료일은 제외)                                                           
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
							                                                                ...
							                                                                경우.<br>
                                                                -국민건강보험법에서 정한 요양급여 또는 의료급여법에서 정한 의료급여 중 본인부담금의 90%
                                                                                                                  해당액과 비급여의 80% <br>해당액의 합계액
                                                                -실제사용병실과 기준병실과의 차액은 50%보상(1일평균금액 10만원한도)<br>
                                                                *국민건강보험법 미적용 시 실제부담액의 40% 보상<br>
                                                                - 치료를 받던 중 보험기간이 만료되었을 경우에는 계속 중인 입원에 대하여 보험기간
                                                               	 종료일로부터 180일까지 보상<br>(보험기간 종료일은 제외)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">국내발생<br>외래의료비</th>
                                                            <td>
							                                                                피보험자가 해외여행중에 입은 상해 또는 질병으로 국내병원에서 통원하여 치료를 받은경우.<br>
							                                                                -국민건강보험법에서 정한 요양급 또는 의료급여법에서 정한 의료급여 중 본인부담금과 비급여의<br>
							                                                                합계액에서 공제금액(병원별 공제금액과 보상대상의료비의 급여 10%해당액과 비급여 20%
							                                                                해당액의 합산액<br> 중 큰 금액)을 차감하고 가입금액 한도로 보상.<br>
							                                     -공제금액: 의원-1만원, 병원-1만5천원, 종합전문요양기관-2만원<br>
							                                     *국민건강보험법 미적용 시 실제부담액의 40% 보상<br>
							                                     - 치료를 받던 중 보험기간이 만료되었을 경우에는 계속 중인 통원치료에 대하여 보험기간
							                                                                종료일로부터<br> 180일이내(방문 90회, 처방전 90건)로 보상.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
							                                                                ...
							                                                                경우.<br>
							                                    -처방전 1건당 국민건강보험범에서 정한 요양급여 또는 의료급여법에서 정한 의료급여 중
							                                                                본인부담금과<br> 비급여의 합계약에서 공제금액(8천원과 보상대상의 의료비급여10%해당액과
							                                                                비급여20%해당액의 합산<br>액중 큰 금액)을 차감하고 가입금액 한도로 보상.<br>
                                                                -공제금액:1회당 8천원<br>
                                                                *국민건강보험법 미적용 시 실제부담액의 40% 보상
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
							                                                                피보험자가 해외여행 중에 질병으로 사망하거나 보험기간 중에 진단확정된 질병으로 약관상
							                                                                장해분류표에<br>서 정한 장해지급률이 80%이상에 해당하는 장해상태가 되었을때 보험증권에 기재된
							                                                                보험가입금액을<br> 지급
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
							                                                                피보험자가 해외여행중 입은 상해 또는 질병의 치료목적으로 국내병원에 입원 또는 통원하여 비급여
							                                                                도수치료<br> 체외충격파치료 증식치료 를 받는경우
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                1회당 2만원과 보상대상의료비의 30% 중 큰 금액 공제. 계약일로부터 1년단위로 350만원
                                                                	이내 50회까<br>지 보상
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
							                                                                피보험자가 해외여행중 입은 상해 질병의 치료목적으로 국내병원에 입원 또는 통원하여 주사치료를
							                                                                받아<br> 본인이 실제로 부담한 비급여 주사료
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                                                               입원.통원 1회당 2만원과 보상대상의료비의 30% 중 큰 금액 공제. 계약일로부터 1년단위로
                                                                250만원 이<br>내에서 입원 통원 합산하여 50회까지 보상
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row" colspan="2" rowspan="2">국내자기공명진단</th>
                                                            <td>
							                                                                피보험자가 해외여행중 입은 상해 질병의 치료목적으로 국내병원에 입원 또는 통원하여
							                                                                자기공명영상진단<br>을 받아 본인이 실제로 부담한 비급여의료비
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                1회당 2만원과 보상대상의료비의 30% 중 큰 금액 공제 .계약일로부터 1년단위로 연간
                                                                300만원 한도내<br> 보상
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
						                                                                  피보험자가 해외여행 중에 생긴 사고로 타인의 신체의 장해 또는 재물의 손해에 대한 법률상의
						                                                                  배상책임을<br> 부담함으로써 입은 손해를 보상 (공제금액-1만원)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row" colspan="2">(해외)여행중 휴대품손해 (분실제외)</th>
                                                            <td>
							                                                                해외여행도중 우연한 사고(도난,파손)로 휴대품에 손해가 생길 경우 1조(또는 1쌍,1개)에
							                                                                대하여 20만원<br>을 한도로 보험가입금액 내에서 실제손해액을 보상. 단, 통화,
							                                                                유가증권,신용카드, 쿠폰, 항공권, 여권, 자<br>동차, 동.식물, 콘택트렌즈 등은 해당사항 없음
							                                                                (자기부담금 1만원)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                다음의 사유로 계약자,피보험자 또는 피보험자의 법정상속인이 부담하는 비용을 보상<br>
                                                                -해외여행 중 피보험자가 탑승한 항공기,선박이 행방불명 또는 조난된경우<br>
                                                                -산악등반 중에 조난된 경우<br>
                                                                -해외여행중 사고에 따라 긴급수색구조 등이 필요한 상태로 된 것이 경찰 등에 공공기관에 의하여
                                                                확인된<br> 경우<br>
                                                                -해외여행 중 상해로 인하여 사망한 경우 또는 14일 이상 계속 입원한 경우
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row" colspan="2">항공기납치</th>
                                                            <td>
                                                                해외여행도중 피보험자가 승객으로서 탑승한 항공기가 납치됨에 따라 예정목적지에 도착할 수 없게
                                                                된 경<br>우 매일 7만원씩 20일을 한도(최고 140만원)로 보상
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>                                            
                                            <p>* 실손의료비(상해/질병)는 보험금을 지급할 다수계약이 체결되어 있는 경우에는 비례보상합니다. 다만, 이미 가입한 보험계약에서 보<br>
                                            										상한 금액이 본인이 부담한 의료비를 초과하였을 때에는 보험금이 지급되지 않을 수 있습니다.</p>
                                            <p>* 보상하는 손해, 보장하지 아니하는 손해등 기타 세부적인 사항은 약관 내용에 따라 제한 될 수 있으니 반드시 약관을 참조하시기 바랍니다.</p>
											<br>
                                            <h4>보상시 필요한서류</h4><hr color="#4A4F5A"> 
                                                ...
                                                <table summary="보상시 필요한 서류" style="font-size:18px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th scope="row" colspan="2">(해외)여행중 휴대품손해 (분실제외)</th>
                                                            <td>
							                                                                사고증명서(도난증명서, 현지경찰확인서 등)<br>
							                                                                손해명세서(손상물 수리견적서, 파손된 휴대품의 사진 등)<br>
							                                                                피해품의 구입가격, 구입처 등이 적힌 서류 <br>
							                                                                여권(입출국도장,사진부분),등본-주민증사본(미성년자경우)<br>
							                                                                경찰신고안되었을경우-목격자확인서,문답서,목격자여권사본
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row" colspan="2">(해외)여행중 중대사고 구조송환비용</th>
                                                            <td>
                                                                사고증명서(사망진단서, 입원확인서 등)<br>
                                                                지출된 비용의 명세서 및 영수증
                                                            </td>
                                                        </tr>
                                                    </tbody>
														...
														<tr>
															<th bgcolor="white" height="80px" style="border: solid 2px #E2E2E2;">
																	<p>*주의사항</p>
						                                                <ul>
						                                                    <li>
						                                                        상해사고/질병 발생시: 의료기관치료시 병원에서 진단서, 치료영수증 구비/약국이용시 영수증 구비
						                                                    </li>
						                                                    <li>
						                                                        휴대폰 도난사고 발생시: 도난사고 발생사실을 인근 경찰서에 신고/ 호텔에서 도난사고 발생시 프론트에
						                                                        신고하여 ​확인<br>증 수령
						                                                    </li>
						                                                    <li>
						                                                        현지에서 준비하셔야 할 서류는 귀국 전 미리 준비해오셔야 합니다.
						                                                        (진단서, 영수증 도난확인서 등)
						                                                    </li>
						                                                </ul>					
																</th>
                                            ...
                                            <p>
					                                                해외여행 중에 상해,질병 등으로 어려움을 당할 때 언제든지 DB손해보험 SOS우리말
					                                                지원서비스에 연락주시면 24시간 연중무휴 언제라도 한국어로 상담해 드립니다.
                                            </p>
                                            <h5>서비스 대상 및 내용</h5>
                                                ...
                                                <table summary="서비스 대상 및 내용"  style="font-size:18px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                               -예방접종 및 비자에 관한 정보제공<br>-여행지의 기후와 환율에 관한 정보제공-인근대사관
                                                               	 또는 영사관의 주소, 전화번호, 근무시간에 관한 정보제공
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table><br>
                                            ...
                                            <p class="prg_desc">- Toll Free(장거리 무료전화)</p><hr color="#4A4F5A">
                                         ...
                                         <h4>MG손해보험 24시간 우리말 지원서비스 (82-2-360-2512)</h4>
                                                <table summary="MG손해보험 24시간 우리말 지원서비스"  style="font-size:18px;"><hr color="#4A4F5A">
