...
<title>케어핀투어 - 허니문</title>
</head>
<body>
	<jsp:include page="../layout/header.jsp" />
	
	<div class="container">
		<h1 class="my-4">허니문</h1>
		<hr>
		<div class="row">
			<div class="col-md-8">
				<div class="card mb-4">
					...
					<div class="card-body">
						<h2 class="card-title">허니문 패키지1</h2>
						<p class="card-text">허니문패키지 설명</p>
				...
				<div class="card mb-4">
					<img class="card-img-top" src="http://placehold.it/750x300" alt="Card image cap">
					<div class="card-body">
						<h2 class="card-title">허니문 패키지2</h2>
						<p class="card-text">허니문패키지 설명</p>
				...
				<div class="card mb-4">
					<img class="card-img-top" src="http://placehold.it/750x300" alt="Card image cap">
					<div class="card-body">
						<h2 class="card-title">허니문 패키지3</h2>
						<p class="card-text">허니문패키지 설명</p>
						<a href="#" class="btn btn-primary">상세 보기</a>
					</div>
					<div class="card-footer text-muted">
