					...
					<th bgcolor="#F9F9F9" height="50px" >																		                         
						<form class="form-inline">	
							<label style="font-size:18px;">숙박 종류</label>
								 &emsp; &emsp;	
								<input type="radio" name="hoteltype" value="" id="hotelAll">&nbsp;<label for="hotelAll">전체</label> &emsp; 
								<input type="radio" name="hoteltype" value="goodStay=1" id="goodStay">&nbsp;<label for="goodStay">굿스테이</label> &emsp; 
								<input type="radio" name="hoteltype" value="hanOk=1" id="hanOk">&nbsp;<label for="hanOk">한옥</label> &emsp; 
								<input type="radio" name="hoteltype" value="benikia=1" id="benikia">&nbsp;<label for="benikia">베니키아</label> 						
						</form>
                   	</th>           
                </tr>
